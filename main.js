...
// Filter active category portfolio item
...
function portfolioItemDetails() {
    ...
    of ${portfolioItems.length} (<span title ="category">${document.querySelector(".portfolio-filter-btn.active").innerHTML} </span>)`;
